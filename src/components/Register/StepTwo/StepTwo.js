    ...
    let countDownView = (
      <Countdown
        ...
        renderRetryFunc={(times)=>{
          let sendText = 'Отправить электронное письмо';
          if (times > 0) {
            sendText = 'Отправить';
          }
      ...
      <Form style={{ maxWidth:350, marginLeft:"auto", marginRight: "auto" }}>
        <FormGroup>
          <Alert bsStyle="warning">
            Пожалуйста, войдите в свою электронную почту, чтобы проверить код подтверждения!
          </Alert>
        </FormGroup>
        <FormGroup>
          <Col sm={8} style={{ marginBottom:10}} >
            <FormControl
              ...
              type="text"
              placeholder="Пожалуйста, введите полученный проверочный код"
              autoComplete="off"
              autoFocus
              />
          </Col>
