...
export const REQUEST_PRODUCTS_DEPLOYMENT_BY_NAME = 'REQUEST_PRODUCTS_DEPLOYMENT_BY_NAME';
export const RECEIVE_PRODUCTS_DEPLOYMENT_BY_NAME = 'RECEIVE_PRODUCTS_DEPLOYMENT_BY_NAME';
export const REQUEST_PRODUCTS_DEPLOYMENT_METRICS = 'REQUEST_PRODUCTS_DEPLOYMENT_METRICS';
export const RECEIVE_PRODUCTS_DEPLOYMENT_METRICS = 'RECEIVE_PRODUCTS_DEPLOYMENT_METRICS';
export const REQUEST_PRODUCTS_DEPLOYMENT_HISTORY = 'REQUEST_PRODUCTS_DEPLOYMENT_HISTORY';
export const RECEIVE_PRODUCTS_DEPLOYMENT_HISTORY = 'RECEIVE_PRODUCTS_DEPLOYMENT_HISTORY';
export const REQUEST_PROMOTE_DEPLOYMENT = 'REQUEST_PROMOTE_DEPLOYMENT';
export const RECEIVE_PROMOTE_DEPLOYMENT = 'RECEIVE_PROMOTE_DEPLOYMENT';
export const RECEIVE_PROMOTE_DEPLOYMENT_ERROR = 'RECEIVE_PROMOTE_DEPLOYMENT_ERROR';
export const SHOW_POP_PROMOTE_DEPLOYMENT = 'SHOW_POP_PROMOTE_DEPLOYMENT';
export const CLOSE_POP_PROMOTE_DEPLOYMENT = 'CLOSE_POP_PROMOTE_DEPLOYMENT';
/*========= end productsActions   ===========*/
